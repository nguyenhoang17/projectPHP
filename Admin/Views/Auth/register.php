                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="index.php?mod=auth&act=handleRegister" method="POST">
                                ...
                                <input type="submit" class="btn btn-primary btn-user btn-block" value="Đăng Ký">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="#">Lấy Lại Mật Khẩu?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="#">Bạn đã có tài khoản? Đăng nhâp!</a>
                            </div>
                        </div>
                    </div>
                </div>
